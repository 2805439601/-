...
Component({
	...
	data: {
		...
		toView: "",
		chatMsg: [],
    userheadimg: wx.getStorageSync('user').avatar_url,
    yourheading: wx.getStorageSync('avatar_url'),
	...
	created(){ 
    var that =this;
    this.data.yourheading = wx.getStorageSync('avatar_url')
    this.data.productMsg = wx.getStorageSync('productMsg')
	},
	attached(){
